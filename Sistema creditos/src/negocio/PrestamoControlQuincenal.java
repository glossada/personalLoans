 ...
 * 
 */
public class PrestamoControlQuincenal {
    private final PrestamoQuinDAO DATOS;
    private PrestamoQuincenal obj;
    private CuotasQuincenal objc;
    private DefaultTableModel modeloTabla;
    public int registrosMostrados;
    
    public PrestamoControlQuincenal(){
        this.DATOS=new PrestamoQuinDAO();
        this.obj=new PrestamoQuincenal();
        this.objc=new CuotasQuincenal();
    ...
    public DefaultTableModel listar(String mes,String año,int totalPorPagina,int numPagina){
        List<PrestamoQuincenal> lista=new ArrayList();
        ...
        String[] titulos={"Id","Id Cliente","Prestamo Nro","Cliente","fecha inicio","Proxima cuota","fecha fin","Vencimiento","monto Prestado","monto a pagar","cuotas", "estado","interes"};
        ...
        this.registrosMostrados=0;
        for (PrestamoQuincenal item:lista){
            ...
            registro[7]=Integer.toString(item.getVencimiento());
            registro[8]=Double.toString(item.getMonto());
            registro[9]=Double.toString(item.getTotalPagar());
            registro[10]=Integer.toString(item.getCuotas());
            registro[11]=item.getEstado();
            registro[12]=Double.toString(item.getInteres());
    ...
    public DefaultTableModel listarDetalle(int id){
        List<CuotasQuincenal> lista=new ArrayList();
        ...
        for (CuotasQuincenal item:lista){
    ...
    public String calcularFechaCuota10(String fecha){
        String[] part=fecha.split("/");
        String fechaFinal;
    ...
    public String calcularFechaCuota24(String fecha){
        String[] part=fecha.split("/");
        String fechaFinal;
        int dia = Integer.parseInt(part[0]);
        int mes = Integer.parseInt(part[1]);
    ...
    public String insertar(int clienteId, String cliente, String prestamoNro, String dia,String mes,String año,int vencimiento,double monto, int cuotas, double totalApagar,String estado, double interesP, int proxCuota,DefaultTableModel modeloDetalles){
        if (DATOS.existe(prestamoNro)){
            ...
            List<CuotasQuincenal> detalles = new ArrayList();
            int cuotaNro;
            String fechaPagar;
            String fechaPagado;
            double valorCuota;
            ...
            for (int i=0;i<modeloDetalles.getRowCount();i++){
                ...
                detalles.add(new CuotasQuincenal(cuotaNro,fechaPagar,valorCuota,interes,ganancia,estadoDet,cuotaPura));
    ...
    public int getVencimiento (int idprestamo){
        return DATOS.getVencimiento(idprestamo);
    }
